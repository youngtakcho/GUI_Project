...
class LoadingDialogWithMessage_login(QtWidgets.QDialog):
    ...
    def retranslateUi(self):
        self.lbl_msg.setText(QtWidgets.QApplication.translate('login-load',"Logging in...."))

    def changeEvent(self, event):
        if event.type() == QtCore.QEvent.LanguageChange:
            self.retranslateUi()
        super(LoadingDialogWithMessage_login, self).changeEvent(event)
